...
export default function LoginPage() {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault()
    if (email === 'admin@grapherp.com' && password === 'admin123') {
        ...
        <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-20 bg-card">
          <div className="mx-auto w-full max-w-sm">
            <div className="flex flex-col items-center mb-10 md:items-start">
              ...
              <p className="mt-2 text-sm text-muted-foreground">Acesse sua conta para gerenciar sua gráfica</p>
            </div>
            ...
            <form className="space-y-6" onSubmit={handleLogin}>
              ...
              <div className="flex items-center justify-end">
                <Link href="/recuperar-acesso" className="text-sm font-semibold text-primary hover:text-primary/80 transition-colors">
                  Esqueci minha senha
                </Link>
              </div>
